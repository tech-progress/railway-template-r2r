...
Treat R2R, Dashboard, graph clustering, configuration, and database schema as one tested release. The current template release is `v1.0.3`, and R2R is pinned to `3.6.5` by manifest digest.
