...
The current template release is `v1.0.4`. Publish the standalone repository's `release-v1` branch and immutable `v1.0.4` tag, then apply `.railway/railway.ts` to a source project.
